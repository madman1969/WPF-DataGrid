...
namespace DataGrid
{
    public class MainWindowViewModel
    {
        ...
        public MainWindowViewModel()
        {
          ...
          this.Customers = CollectionViewSource.GetDefaultView(_customers);

          this.GroupedCustomers = new ListCollectionView(_customers);
          this.GroupedCustomers.GroupDescriptions.Add(new PropertyGroupDescription("Gender"));
